 ...
 * @author ASUS
 */
public class ControllerL2G8_GUI implements ActionListener{
    L2G8_GUI View;
    Database DB;
    static int lives=ControllerL2G7_GUI.lives;
    static int score=ControllerL2G7_GUI.score;
    
    public ControllerL2G8_GUI() {
        DB = new Database();
        View= new L2G8_GUI();
