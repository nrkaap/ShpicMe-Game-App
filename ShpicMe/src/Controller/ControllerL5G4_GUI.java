 ...
 * @author ASUS
 */
public class ControllerL5G4_GUI implements ActionListener{
    L5G4_GUI View;
    Database DB;
    static int lives=ControllerL5G3_GUI.lives;
    static int score=ControllerL5G3_GUI.score;
    
    public ControllerL5G4_GUI() {
        DB = new Database();
        View= new L5G4_GUI();
