 ...
 * @author ASUS
 */
public class ControllerL5G9_GUI implements ActionListener{
    L5G9_GUI View;
    Database DB;
    static int lives=ControllerL5G8_GUI.lives;
    static int score=ControllerL5G8_GUI.score;
    
    public ControllerL5G9_GUI() {
        DB = new Database();
        View= new L5G9_GUI();
