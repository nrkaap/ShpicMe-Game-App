...
import static Controller.ControllerL1G7_GUI.lives;
import Model.Database;
import View.L1G7_GUI;
 ...
 */
public class ControllerL1G8_GUI implements ActionListener{
    L1G8_GUI View;
    Database DB;
    static int lives=ControllerL1G7_GUI.lives;
    static int score=ControllerL1G7_GUI.score;

    public ControllerL1G8_GUI() {
        DB = new Database();
        View= new L1G8_GUI();
    ...
    public void btnCekActionPerformed(){
        if (View.getTfjawaban().equals("Out of the box")||View.getTfjawaban().equals("out of the box")||View.getTfjawaban().equals("OUT OF THE BOX")){
