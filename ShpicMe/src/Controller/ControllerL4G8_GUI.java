 ...
 * @author ASUS
 */
public class ControllerL4G8_GUI implements ActionListener{
    L4G8_GUI View;
    Database DB;
    static int lives=ControllerL4G7_GUI.lives;
    static int score=ControllerL4G7_GUI.score;
    
    public ControllerL4G8_GUI() {
        DB = new Database();
        View= new L4G8_GUI();
