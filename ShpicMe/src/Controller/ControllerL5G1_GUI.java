 ...
 * @author ASUS
 */
public class ControllerL5G1_GUI implements ActionListener{
    L5G1_GUI View;
    Database DB;
    static int lives=ControllerL4G12_GUI.lives;
    static int score=ControllerL4G12_GUI.score;
    
    public ControllerL5G1_GUI() {
        DB = new Database();
        View= new L5G1_GUI();
