 ...
 * @author ASUS
 */
public class ControllerL3G1_GUI implements ActionListener{
    L3G1_GUI View;
    Database DB;
    static int lives=ControllerL2G12_GUI.lives;
    static int score=ControllerL2G12_GUI.score;
    
    public ControllerL3G1_GUI() {
        DB = new Database();
        View= new L3G1_GUI();
