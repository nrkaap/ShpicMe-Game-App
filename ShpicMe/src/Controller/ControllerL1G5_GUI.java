...
import static Controller.ControllerL1G4_GUI.lives;
 ...
 */
public class ControllerL1G5_GUI extends ControllerL1G4_GUI implements ActionListener {
    L1G5_GUI View;
    Database DB;
    static int lives=ControllerL1G4_GUI.lives;
    static int score=ControllerL1G4_GUI.score;
    public ControllerL1G5_GUI() {
        DB = new Database();
        View= new L1G5_GUI();
    ...
    public void btnCekActionPerformed(){
        if (View.getTfjawaban().equals("Angin topan")||View.getTfjawaban().equals("angin topan")||View.getTfjawaban().equals("ANGIN TOPAN")){
