 ...
 * @author ASUS
 */
public class ControllerL3G7_GUI implements ActionListener{
    L3G7_GUI View;
    Database DB;
    static int lives=ControllerL3G6_GUI.lives;
    static int score=ControllerL3G6_GUI.score;
    
    public ControllerL3G7_GUI() {
        DB = new Database();
        View= new L3G7_GUI();
