 ...
 * @author ASUS
 */
public class ControllerL5G5_GUI implements ActionListener{
    L5G5_GUI View;
    Database DB;
    static int lives=ControllerL5G4_GUI.lives;
    static int score=ControllerL5G4_GUI.score;
    
    public ControllerL5G5_GUI() {
        DB = new Database();
        View= new L5G5_GUI();
