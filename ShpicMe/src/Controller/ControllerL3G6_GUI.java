 ...
 * @author ASUS
 */
public class ControllerL3G6_GUI implements ActionListener{
    L3G6_GUI View;
    Database DB;
    static int lives=ControllerL3G5_GUI.lives;
    static int score=ControllerL3G5_GUI.score;
    
    public ControllerL3G6_GUI() {
        DB = new Database();
        View= new L3G6_GUI();
