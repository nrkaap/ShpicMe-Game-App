 ...
 * @author ASUS
 */
public class ControllerL4G6_GUI implements ActionListener{
    L4G6_GUI View;
    Database DB;
    static int lives=ControllerL4G5_GUI.lives;
    static int score=ControllerL4G5_GUI.score;
    
    public ControllerL4G6_GUI() {
        DB = new Database();
        View= new L4G6_GUI();
