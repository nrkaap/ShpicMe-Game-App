 ...
 * @author ASUS
 */
public class ControllerL5G8_GUI implements ActionListener{
    L5G8_GUI View;
    Database DB;
    static int lives=ControllerL5G7_GUI.lives;
    static int score=ControllerL5G7_GUI.score;
    
    public ControllerL5G8_GUI() {
        DB = new Database();
        View= new L5G8_GUI();
