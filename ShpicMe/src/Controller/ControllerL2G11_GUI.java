 ...
 * @author ASUS
 */
public class ControllerL2G11_GUI implements ActionListener{
    L2G11_GUI View;
    Database DB;
    static int lives=ControllerL2G10_GUI.lives;
    static int score=ControllerL2G10_GUI.score;
    public ControllerL2G11_GUI() {
        DB = new Database();
        View= new L2G11_GUI();
    ...
    public void btnCekActionPerformed(){
        if (View.getTfjawaban().equals("Putri titian")||View.getTfjawaban().equals("putri titian")||View.getTfjawaban().equals("PUTRI TITIAN")){
