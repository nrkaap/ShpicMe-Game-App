 ...
 * @author ASUS
 */
public class ControllerL5G6_GUI implements ActionListener{
    L5G6_GUI View;
    Database DB;
    static int lives=ControllerL5G5_GUI.lives;
    static int score=ControllerL5G5_GUI.score;
    
    public ControllerL5G6_GUI() {
        DB = new Database();
        View= new L5G6_GUI();
