...
import static Controller.ControllerL2G4_GUI.lives;
import Model.Database;
import View.L2G5_GUI;
 ...
 * @author ASUS
 */
public class ControllerL2G5_GUI implements ActionListener{
    L2G5_GUI View;
    Database DB;
    static int lives=ControllerL2G4_GUI.lives;
    static int score=ControllerL2G4_GUI.score;
    
    public ControllerL2G5_GUI() {
        DB = new Database();
        View= new L2G5_GUI();
    ...
    public void btnCekActionPerformed(){
        if (View.getTfjawaban().equals("Kentang goreng")||View.getTfjawaban().equals("kentang goreng")||View.getTfjawaban().equals("KENTANG GORENG")){
            View.showMessage("Yeaaay jawabanmu benar, skormu bertambah 5", "Success", 1);
            hitungscore();
            new ControllerL2G6_GUI();
            View.dispose();
