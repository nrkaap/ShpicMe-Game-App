 ...
 * @author ASUS
 */
public class ControllerL3G11_GUI implements ActionListener{
    L3G11_GUI View;
    Database DB;
    static int lives=ControllerL3G10_GUI.lives;
    static int score=ControllerL3G10_GUI.score;
    
    public ControllerL3G11_GUI() {
        DB = new Database();
        View= new L3G11_GUI();
