 ...
 * @author ASUS
 */
public class ControllerL5G2_GUI implements ActionListener{
    L5G2_GUI View;
    Database DB;
    static int lives=ControllerL5G1_GUI.lives;
    static int score=ControllerL5G1_GUI.score;
    
    public ControllerL5G2_GUI() {
        DB = new Database();
        View= new L5G2_GUI();
