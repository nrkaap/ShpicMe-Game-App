 ...
 * @author ASUS
 */
public class ControllerL3G5_GUI implements ActionListener{
    L3G5_GUI View;
    Database DB;
    static int lives=ControllerL3G4_GUI.lives;
    static int score=ControllerL3G4_GUI.score;
    
    public ControllerL3G5_GUI() {
        DB = new Database();
        View= new L3G5_GUI();
