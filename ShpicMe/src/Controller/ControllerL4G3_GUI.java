 ...
 */
public class ControllerL4G3_GUI implements ActionListener {
    L4G3_GUI View;
    Database DB;
    static int lives=ControllerL4G2_GUI.lives;
    static int score=ControllerL4G2_GUI.score;
    
    public ControllerL4G3_GUI() {
        DB = new Database();
        View= new L4G3_GUI();
