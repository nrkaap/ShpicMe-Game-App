 ...
 * @author ASUS
 */
public class ControllerL5G3_GUI implements ActionListener{
    L5G3_GUI View;
    Database DB;
    static int lives=ControllerL5G2_GUI.lives;
    static int score=ControllerL5G2_GUI.score;
    
    public ControllerL5G3_GUI() {
        DB = new Database();
        View= new L5G3_GUI();
