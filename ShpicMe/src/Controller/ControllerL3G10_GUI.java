 ...
 * @author ASUS
 */
public class ControllerL3G10_GUI implements ActionListener{
    L3G10_GUI View;
    Database DB;
    static int lives=ControllerL3G9_GUI.lives;
    static int score=ControllerL3G9_GUI.score;
    
    public ControllerL3G10_GUI() {
        DB = new Database();
        View= new L3G10_GUI();
