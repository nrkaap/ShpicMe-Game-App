 ...
 * @author ASUS
 */
public class ControllerL5G12_GUI implements ActionListener{
    L5G12_GUI View;
    Database DB;
    static int lives=ControllerL5G11_GUI.lives;
    static int score=ControllerL5G11_GUI.score;
    
    public ControllerL5G12_GUI() {
        DB = new Database();
        View= new L5G12_GUI();
