 ...
 * @author ASUS
 */
public class ControllerL3G4_GUI implements ActionListener{
    L3G4_GUI View;
    Database DB;
    static int lives=ControllerL3G3_GUI.lives;
    static int score=ControllerL3G3_GUI.score;
    
    public ControllerL3G4_GUI() {
        DB = new Database();
        View= new L3G4_GUI();
