...
import static Controller.ControllerL1G6_GUI.lives;
 ...
 */
public class ControllerL1G7_GUI implements ActionListener{
    L1G7_GUI View;
    Database DB;
    static int lives=ControllerL1G6_GUI.lives;
    static int score=ControllerL1G6_GUI.score;

    public ControllerL1G7_GUI() {
        DB = new Database();
        View= new L1G7_GUI();
    ...
    public void btnCekActionPerformed(){
        if (View.getTfjawaban().equals("Pintu surga")||View.getTfjawaban().equals("pintu surga")||View.getTfjawaban().equals("PINTU SURGA")){
