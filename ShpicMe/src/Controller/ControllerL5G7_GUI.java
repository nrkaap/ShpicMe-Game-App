 ...
 * @author ASUS
 */
public class ControllerL5G7_GUI implements ActionListener{
    L5G7_GUI View;
    Database DB;
    static int lives=ControllerL5G6_GUI.lives;
    static int score=ControllerL5G6_GUI.score;
    
    public ControllerL5G7_GUI() {
        DB = new Database();
        View= new L5G7_GUI();
