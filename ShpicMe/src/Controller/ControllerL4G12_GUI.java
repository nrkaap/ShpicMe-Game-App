 ...
 * @author ASUS
 */
public class ControllerL4G12_GUI implements ActionListener{
    L4G12_GUI View;
    Database DB;
    static int lives=ControllerL4G11_GUI.lives;
    static int score=ControllerL4G11_GUI.score;
    
    public ControllerL4G12_GUI() {
        DB = new Database();
        View= new L4G12_GUI();
