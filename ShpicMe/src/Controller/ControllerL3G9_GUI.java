 ...
 * @author ASUS
 */
public class ControllerL3G9_GUI implements ActionListener{
    L3G9_GUI View;
    Database DB;
    static int lives=ControllerL3G8_GUI.lives;
    static int score=ControllerL3G8_GUI.score;
    
    public ControllerL3G9_GUI() {
        DB = new Database();
        View= new L3G9_GUI();
