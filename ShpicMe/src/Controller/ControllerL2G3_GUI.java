 ...
 */
public class ControllerL2G3_GUI implements ActionListener{
    L2G3_GUI View;
    Database DB;
    static int lives=ControllerL2G2_GUI.lives;
    static int score=ControllerL2G2_GUI.score;
    public ControllerL2G3_GUI() {
        DB = new Database();
        View= new L2G3_GUI();
    ...
    public void btnCekActionPerformed(){
        if (View.getTfjawaban().equals("Sepasang sepatu")||View.getTfjawaban().equals("sepasang sepatu")||View.getTfjawaban().equals("Sepasang sepatu")){
