 ...
 * @author ASUS
 */
public class ControllerL3G8_GUI implements ActionListener{
    L3G8_GUI View;
    Database DB;
    static int lives=ControllerL3G7_GUI.lives;
    static int score=ControllerL3G7_GUI.score;
    
    public ControllerL3G8_GUI() {
        DB = new Database();
        View= new L3G8_GUI();
