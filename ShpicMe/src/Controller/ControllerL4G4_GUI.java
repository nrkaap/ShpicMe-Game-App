...
import View.L4G1_GUI;
import View.L4G4_GUI;
 ...
 */
public class ControllerL4G4_GUI implements ActionListener{
    L4G4_GUI View;
    Database DB;
    static int lives=ControllerL4G3_GUI.lives;
    static int score=ControllerL4G3_GUI.score;
    
    public ControllerL4G4_GUI() {
        DB = new Database();
        View= new L4G4_GUI();
