 ...
 * @author ASUS
 */
public class ControllerL4G10_GUI implements ActionListener{
    L4G10_GUI View;
    Database DB;
    static int lives=ControllerL4G9_GUI.lives;
    static int score=ControllerL4G9_GUI.score;
    
    public ControllerL4G10_GUI() {
        DB = new Database();
        View= new L4G10_GUI();
