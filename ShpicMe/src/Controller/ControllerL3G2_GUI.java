 ...
 * @author ASUS
 */
public class ControllerL3G2_GUI implements ActionListener{
    L3G2_GUI View;
    Database DB;
    static int lives=ControllerL3G1_GUI.lives;
    static int score=ControllerL3G1_GUI.score;
    
    public ControllerL3G2_GUI() {
        DB = new Database();
        View= new L3G2_GUI();
