 ...
 * @author ASUS
 */
public class ControllerL2G9_GUI implements ActionListener{
    L2G9_GUI View;
    Database DB;
    static int lives=ControllerL2G8_GUI.lives;
    static int score=ControllerL2G8_GUI.score;
    
    public ControllerL2G9_GUI() {
        DB = new Database();
        View= new L2G9_GUI();
