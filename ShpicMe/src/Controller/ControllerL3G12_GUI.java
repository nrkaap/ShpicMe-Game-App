 ...
 * @author ASUS
 */
public class ControllerL3G12_GUI implements ActionListener{
    L3G12_GUI View;
    Database DB;
    static int lives=ControllerL3G11_GUI.lives;
    static int score=ControllerL3G11_GUI.score;
    
    public ControllerL3G12_GUI() {
        DB = new Database();
        View= new L3G12_GUI();
