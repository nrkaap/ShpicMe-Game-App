 ...
 */
public class ControllerL1G3_GUI extends ControllerL1G2_GUI implements ActionListener{
    L1G3_GUI View;
    Database DB;
    static int lives=ControllerL1G2_GUI.lives;
    static int score=ControllerL1G2_GUI.score;

    public ControllerL1G3_GUI() {
        DB = new Database();
        View= new L1G3_GUI();
    ...
    public void btnCekActionPerformed(){
        if (View.getTfjawaban().equals("Mickey mouse")||View.getTfjawaban().equals("mickey mouse")||View.getTfjawaban().equals("MICKEY MOUSE")){
