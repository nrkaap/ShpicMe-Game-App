...
import static Controller.ControllerL2G3_GUI.lives;
import Model.Database;
import View.L2G3_GUI;
import View.L2G4_GUI;
 ...
 */
public class ControllerL2G4_GUI implements ActionListener{
    L2G4_GUI View;
    Database DB;
    static int lives=ControllerL2G3_GUI.lives;
    static int score=ControllerL2G3_GUI.score;

    public ControllerL2G4_GUI() {
        DB = new Database();
        View= new L2G4_GUI();
    ...
    public void btnCekActionPerformed(){
        if (View.getTfjawaban().equals("Banda aceh")||View.getTfjawaban().equals("banda aceh")||View.getTfjawaban().equals("BANDA ACEH")){
            View.showMessage("Yeaaay jawabanmu benar, skormu bertambah 5", "Success", 1);
            hitungscore();
            new ControllerL2G5_GUI();
            View.dispose();
