 ...
 */
public class ControllerL4G2_GUI implements ActionListener{
    L4G2_GUI View;
    Database DB;
    static int lives=ControllerL4G1_GUI.lives;
    static int score=ControllerL4G1_GUI.score;
    
    public ControllerL4G2_GUI() {
        DB = new Database();
        View= new L4G2_GUI();
