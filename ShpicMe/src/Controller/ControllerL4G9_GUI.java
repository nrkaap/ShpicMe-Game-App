 ...
 * @author ASUS
 */
public class ControllerL4G9_GUI implements ActionListener{
    L4G9_GUI View;
    Database DB;
    static int lives=ControllerL4G8_GUI.lives;
    static int score=ControllerL4G8_GUI.score;
    
    public ControllerL4G9_GUI() {
        DB = new Database();
        View= new L4G9_GUI();
