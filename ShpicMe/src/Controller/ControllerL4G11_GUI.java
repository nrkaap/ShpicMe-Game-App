 ...
 * @author ASUS
 */
public class ControllerL4G11_GUI implements ActionListener{
    L4G11_GUI View;
    Database DB;
    static int lives=ControllerL4G10_GUI.lives;
    static int score=ControllerL4G10_GUI.score;
    
    public ControllerL4G11_GUI() {
        DB = new Database();
        View= new L4G11_GUI();
