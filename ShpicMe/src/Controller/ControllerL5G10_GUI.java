...
import View.L5G10_GUI;
import View.L5G9_GUI;
 ...
 * @author ASUS
 */
public class ControllerL5G10_GUI implements ActionListener{
    L5G10_GUI View;
    Database DB;
    static int lives=ControllerL5G9_GUI.lives;
    static int score=ControllerL5G9_GUI.score;
    
    public ControllerL5G10_GUI() {
        DB = new Database();
        View= new L5G10_GUI();
