...
import static Controller.ControllerL2G5_GUI.lives;
import Model.Database;
import View.L2G6_GUI;
 ...
 * @author ASUS
 */
public class ControllerL2G6_GUI implements ActionListener{
    L2G6_GUI View;
    Database DB;
    static int lives=ControllerL2G5_GUI.lives;
    static int score=ControllerL2G5_GUI.score;
    
    public ControllerL2G6_GUI() {
        DB = new Database();
        View= new L2G6_GUI();
