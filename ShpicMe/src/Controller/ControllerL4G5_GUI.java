 ...
 * @author ASUS
 */
public class ControllerL4G5_GUI implements ActionListener{
    L4G5_GUI View;
    Database DB;
    static int lives=ControllerL4G4_GUI.lives;
    static int score=ControllerL4G4_GUI.score;
    
    public ControllerL4G5_GUI() {
        DB = new Database();
        View= new L4G5_GUI();
