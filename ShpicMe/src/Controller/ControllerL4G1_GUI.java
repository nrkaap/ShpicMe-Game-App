 ...
 */
public class ControllerL4G1_GUI implements ActionListener {
    L4G1_GUI View;
    Database DB;
    static int lives=ControllerL3G12_GUI.lives;
    static int score=ControllerL3G12_GUI.score;
    
    public ControllerL4G1_GUI() {
        DB = new Database();
        View= new L4G1_GUI();
