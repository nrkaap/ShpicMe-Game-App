 ...
 * @author ASUS
 */
public class ControllerL2G7_GUI implements ActionListener{
    L2G7_GUI View;
    Database DB;
    static int lives=ControllerL2G6_GUI.lives;
    static int score=ControllerL2G6_GUI.score;
    
    public ControllerL2G7_GUI() {
        DB = new Database();
        View= new L2G7_GUI();
